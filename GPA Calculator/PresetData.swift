...
func getPresets() -> [Course] {
    ...
    let g10 = Course.init(id: "stockshsidgrade10", name: "Grade 10", subjectComputeGroup: [
        ...
        Subject.fastOther(name: "Elective 1", weight: 3, alternateNames: g10ElectivesChoice, hasSP: false, hasH: true, hasAL: false, hasAP: true),
        Subject.fastOther(name: "Elective 2", weight: 3, alternateNames: g10ElectivesChoice, hasSP: false, hasH: true, hasAL: false, hasAP: true),
